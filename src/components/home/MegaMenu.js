...
const MegaMenu = () => {
  const [showMenu, setShowMenu] = useState(Array(14).fill(false));
        ...
        {showMenu.map((isOpen, index) => (
          <div className="ltr" key={index}>
            <button
              ...
              className="bg-white flex justify-between items-center text-[#444] p-2 w-full border-[#ddd] border text-[14px] text-left outline-none font-UbuntuMedium transition-all duration-[0.4s] shadow-sm hover:bg-[#051b35] hover:text-white"
            >
